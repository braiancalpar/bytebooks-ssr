    ...
    <div>
      {selectedBook && (
        <>
          ...
          <Breadcrumb
            onReturnHome={() => navigate.push("/")}
            currentPageName="Detalhes do livro"
          />
          <div className="mt-20 px-8 md:px-20 xl:px-80 w-full pb-10">
            <div className="flex flex-col md:flex-row items-center md:items-start">
              ...
              <div className="mx-5 mt-4 md:mt-0">
                <h2 className="text-[#002F52] text-3xl">
                  {selectedBook?.title}
                </h2>
                  ...
                  <button
                    ...
                    onClick={() => {
                      addToCart({
                        ...selectedBook,
                        quantity,
                        price: selectedBook?.prices.ebook,
                      });
                      setIsCartOpen(true);
                    }}
                  >
            ...
            <div>
              ...
              <p className="text-[#221F20] text-base mt-4">
